...
| 伝動 | GT2 6mm ベルト + 20T プーリー → 40 steps/mm（1/8マイクロステップ時） |
| 電源 | 12V 4A |
| 描画エリア | 1400 × 580mm（案A） |
...
リポジトリ各部の役割、座標系、逆運動学、左右モーターの同期制御、
ペン昇降、文字・画像・Web UIから実描画までの流れは
[リポジトリ構成と Plotter の仕組み](docs/architecture-and-plotter.md)を参照。
